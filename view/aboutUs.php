    ...
    <div class="container">
        <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
            <div class="col-12 col-lg-6" >
                <img src="https://gizmodo.uol.com.br/wp-content/blogs.dir/8/files/2022/10/linux-6-0-e-oficialmente-lancado-veja-o-que-ha-de-novo.jpg" class="img-fluid img-thumbnail rounded-rectangle br-80" width="500px" height="500" alt="profile" style=""></div>
            <div class="col-12 col-lg-6">
                <div class="row justify-content-xl-center">
                    <div class="col-12 col-xl-10">
                        ...
                        <a href="/contactUs"> <button type="button" class="btn bsb-btn-2xl btn-outline-primary rounded-pill">Connect Now</button></a>
                    </div>
                </div>
            </div>
        </div>
